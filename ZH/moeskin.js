...
mw.hook("InPageEdit").add(function (ctx) {
    ...
    mw.hook("moeskin.pagetools").add(function (_a) {
        var $ipebtn = _a.addPageToolsButton("<span style=\"align-self:center;font:0.7em bold;\">IPE</span>", "快速编辑");
        $ipebtn.attr({ id: "ca-inpageedit", href: "javascript:void(0)" }).on("click", function () {
